...
Slope = Polygon([(0.0,0.0),(0.1,1.0),(med_low,1.0)])
Happiness_bad = merge(AlgebraicProduct(), Happiness_bad, Slope) 
...
Slope2 = Polygon([(med_high,1.0),(99.9,1.0),(100.0,0.0)])
Happiness_high = merge(AlgebraicProduct(), Happiness_high, Slope2) 
